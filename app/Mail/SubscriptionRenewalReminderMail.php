...
class SubscriptionRenewalReminderMail extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: $this->template()['subject'] ?? __('Upcoming renewal for :product', [
    ...
    public function content(): Content
    {
        ...
        if ($template !== null) {
            return new Content(
                view: 'mail.template',
                with: ['body' => $template['html'], 'badge' => __('Upcoming renewal')],
            );
        }
    ...
    private function template(): ?array
    {
        ...
        return app(EmailTemplateService::class)->render('subscription-renewal-reminder', [
            ...
            'renewal_date' => $this->subscription->current_period_end?->format('d M Y') ?? '',
